...
const Casino = () => {
  ...
  return (
    <div className="relative flex flex-col gap-1 px-[1px] h-full md:pb-0 overflow-auto scrollbar-hide w-full mt-2">
      <div
        id="scrollToTopDiv"
          ...
          <div className="w-full h-full scrollbar-hide">
            <div className="flex flex-col gap-0.5">
              <div className="flex justify-between items-center bg-sportsTitleBg ps-4 pe-2 py-1.5 h-[45px]">
                <div className="flex items-center gap-2 text-lg  font-black uppercase relative">
                  <img
                ...
                <div className="flex items-center w-[200px] md:w-[250px] md:rounded text-xs">
                  <div className="flex flex-col w-full whitespace-nowrap rounded mb-2 ">
                    <label htmlFor className="self-start" />
                    <input
                      onChange={(e) => setSearch(e.target.value)}
                      value={search}
                      type="text"
                      className="flex shrink-0 mt-2 rounded-l bg-loginInputGray outline-none border-solid h-[32px] pl-1 text-[14px] font-sans font-semibold text-primary placeholder:text-primary"
