    ...
    >
      ...
      <div className="w-full text-center">
        <button
          ...
          className="inline-block leading-normal relative overflow-hidden transition duration-150 ease-in-out bg-buttonGradient w-full text-primary h-10 text-base shadow-lg  rounded-md font-[900] leading-4 disabled:opacity-70 flex gap-x-1 items-center justify-center cursor-pointer"
        >
          <span>SUBMIT</span>
        </button>
      </div>
