    ...
    <>
      {Settings?.instagramLink ? (
        <div
          ...
          className="fixed cursor-pointer top-[calc(100dvh-255px)] left-4 z-30 flex w-max h-max items-center justify-center rounded-full transition-all duration-500"
        >
      ...
      {Settings?.telegramLink ? (
        <div
          ...
          title="WhatsAppContact"
          className="fixed cursor-pointer top-[calc(100dvh-210px)] left-4 z-30 flex w-max h-max items-center justify-center rounded-full transition-all duration-500"
        >
          <div className="h-full bg-transparent mt-[-3px] ml-[-3px]">
      ...
      {Settings?.whatsapplink || Settings?.branchWhatsapplink ? (
        <div
          ...
          title="WhatsAppContact"
          className="fixed cursor-pointer top-[calc(100dvh-165px)] left-3 z-30 flex w-max h-max items-center justify-center rounded-full transition-all duration-500"
        >
          <div className="h-full bg-transparent mt-[-3px] ml-[-3px]">
            <svg
              width="49"
