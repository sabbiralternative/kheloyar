              ...
              {child?.childs?.map((children) => {
                return (
                  <button
                    ...
                    className=" active:opacity-70 h-5 text-xs text-center text-white px-2 rounded-full bg-inputPlaceholderText hover:text-reportsTableHeaderText hover:bg-buttonGradient"
                  >
