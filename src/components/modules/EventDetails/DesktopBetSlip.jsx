...
const DesktopBetSlip = ({ currentPlaceBetEvent }) => {
  ...
  return (
    <div className>
      <div
        className={`${placeBetValues?.back ? "bg-[#72BBEF]" : "bg-[#FAA9BA]"} relative`}
      >
        <div className="flex items-center justify-between gap-2 text-black px-2">
          ...
          <div
            ...
            className="flex items-center justify-center bg-loginInputGray rounded-full h-[28px] w-[28px] cursor-pointer"
          >
            <img
        ...
        >
          <div className="flex items-center w-full">
            ...
            <input
              ...
              value={price}
              className="h-[30px] w-full text-center text-[12px] text-black"
            />
            {!placeBetValues?.isWeak && (
              <button
                onClick={() => {
